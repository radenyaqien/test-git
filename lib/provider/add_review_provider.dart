...
import 'package:testgit/data/model/review/add_review_body.dart';
import 'package:testgit/data/model/review/add_review_response.dart';
...
class AddReviewProvider extends ChangeNotifier {
  ...
  Future<dynamic> addReview() async {
    try {
      ...
      notifyListeners();
      final restaurant = await apiService.addReview(
        AddReviewBody(id: _rId, name: _rName, review: _rReview),
      );
      if (restaurant.error) {
