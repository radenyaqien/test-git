...
import 'package:testgit/provider/restaurant_detail_provider.dart';
import 'package:testgit/util.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(restaurant.description, textAlign: TextAlign.justify),
            ),
            const Padding(
            ...
            HorizontalGridView(drinks: restaurant.menus.drinks),
            const Padding(
            ...
            HorizontalGridView(drinks: restaurant.menus.foods),
          ],
        ),
      ),
    );
